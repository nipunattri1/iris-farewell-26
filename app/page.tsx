        ...
        <div className="flex flex-row justify-between items-start gap-4 mb-10">
          <div className="space-y-1 text-sm min-w-0">
            <div className="grid grid-cols-[100px_1fr] gap-x-2">
              ...
              <span className="break-all md:break-normal">Team IRIS &lt;team@iris.nitk.ac.in&gt;</span>
            </div>

            <div className="grid grid-cols-[100px_1fr] gap-x-2">
              <span className="font-bold">To:</span>
              <span className="break-all md:break-normal">IRIS 26 &lt;iris26@iris.nitk.ac.in&gt;</span>
            </div>
        ...
        <div className="mb-12 text-[15px] leading-snug">
          <div className="mb-12 text-[15px] leading-snug">
            <p className="mb-9 font-normal leading-relaxed">
              ...
              Here is the final final. I have decided to make a change of the venue from <span className="bg-black highlight:text-white px-1 font-bold">____</span> to <Link className="underline hover:bg-black hover:text-white" href={"https://maps.app.goo.gl/Sy4vTq5QtrgUctCW9"}>The Avatar Flexi - 1st Floor</Link> to reduce the number of travel minutes. I have specially handpicked both <span className="bg-black highlight:text-white px-1 font-bold">Pizzas</span> and <span className="bg-black highlight:text-white px-1 font-bold">Drinks</span> to suit all your needs. We have pizzas, grape juice and ice creams waiting for you on 20th March 5 PM. I was unfortunately not able to get my hands on cheese and hotdog. Whoops!
              <br />
